...
namespace Z.EntityFramework.Plus
{
    internal class ExceptionMessage
    {
        ...
        public static string QueryIncludeOptimize_ArgumentExpression = "Oops! immediate method with expression argument are not supported. For more information, contact us: info@zzzprojects.com";
        public static string QueryIncludeOptimize_CreateQueryElement = "Oops! Select projection are not supported in EF+ Query IncludeFilter For more information, contact us: info@zzzprojects.com";
    }
}