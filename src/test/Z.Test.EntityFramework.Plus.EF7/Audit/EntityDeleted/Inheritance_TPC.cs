...
namespace Z.Test.EntityFramework.Plus
{
    public partial class Audit_EntityDeleted
    {
        ...
        public void Inheritance_TPC()
        {
            ...
            {
                TestContext.DeleteAll(ctx, x => x.Inheritance_TPC_Animals);
            ...
            // UnitTest - Audit
            {
                ...
                // Properties
                {
                    ...
                    Assert.AreEqual(identitySeedCat + 1, entries[0].Properties[propertyIndex].OldValue);
                    Assert.AreEqual(identitySeedDog + 1, entries[1].Properties[propertyIndex].OldValue);
                    Assert.AreEqual(identitySeedDog + 2, entries[2].Properties[propertyIndex].OldValue);
            ...
            // UnitTest - Audit (Database)
            {
                using (var ctx = new TestContext())
                {
                    ...
                    // Properties
                    {
                        ...
                        Assert.AreEqual("ID", entries[1].Properties[propertyIndex].PropertyName);
                        Assert.AreEqual("ID", entries[2].Properties[propertyIndex].PropertyName);
                        Assert.AreEqual((identitySeedCat + 1).ToString(), entries[0].Properties[propertyIndex].OldValue);
                        Assert.AreEqual((identitySeedDog + 1).ToString(), entries[1].Properties[propertyIndex].OldValue);
                        Assert.AreEqual((identitySeedDog + 2).ToString(), entries[2].Properties[propertyIndex].OldValue);
                        Assert.AreEqual(null, entries[0].Properties[propertyIndex].NewValue);
                        Assert.AreEqual(null, entries[1].Properties[propertyIndex].NewValue);
                        Assert.AreEqual(null, entries[2].Properties[propertyIndex].NewValue);
