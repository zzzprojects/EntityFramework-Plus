...
namespace Z.Test.EntityFramework.Plus
{
    ...
    {
        [TestMethod]
        public void RightEmpty_Many_Enumerator()
        {
            ...
            using (var ctx = new TestContext())
            {
                var list = ctx.Association_Multi_OneToMany_Lefts
                    .IncludeOptimized(left => left.Right1s.Where(y => y.ColumnInt > 99))
                    .IncludeOptimized(left => left.Right2s.Where(y => y.ColumnInt > 99))
                    .ToList();
