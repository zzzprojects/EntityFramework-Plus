    ...
    public partial class BatchUpdate_BatchSize
    {
        ...
        public void Default()
        {
            ...
            using (var ctx = new TestContext())
            {
                ...
                clock.Start();
                var rowsAffected = ctx.Entity_Basics.Where(x => x.ColumnInt > 10 && x.ColumnInt <= 40).Update(x => new Entity_Basic { ColumnInt = 99 }, update => { batchSizeValue = update.BatchSize; });
                clock.Stop();
