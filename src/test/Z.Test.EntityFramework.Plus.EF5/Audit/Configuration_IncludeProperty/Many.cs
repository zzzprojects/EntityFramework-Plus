...
{
    public partial class Audit_Configuration_IncludeProperty
    {
        [TestMethod]
        public void Many()
        {
            ...
            audit.Configuration.ExcludeProperty<Inheritance_TPC_Cat>(x => new {x.ID, x.ColumnInt, x.ColumnCat});
            audit.Configuration.IncludeProperty<Inheritance_TPC_Cat>(x => new {x.ID, x.ColumnCat});
