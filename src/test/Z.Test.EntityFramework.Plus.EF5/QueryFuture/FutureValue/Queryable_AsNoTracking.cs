    ...
    public partial class QueryFuture_FutureValue
    {
        ...
        public void Queryable_AsNoTracking()
        {
            ...
            using (var ctx = new EntityContext())
            {
                ...
                var futureValue1 = ctx.EntitySimples.Where(x => x.ColumnInt < 5).OrderBy(x => x.ColumnInt).AsNoTracking().FutureValue();
                var futureValue2 = ctx.EntitySimples.Where(x => x.ColumnInt >= 5).OrderBy(x => x.ColumnInt).AsNoTracking().FutureValue();
