    ...
    public partial class QueryFuture_Future
    {
        ...
        public void Queryable_AsNoTracking()
        {
            ...
            using (var ctx = new EntityContext())
            {
                ...
                var futureList1 = ctx.EntitySimples.Where(x => x.ColumnInt < 5).AsNoTracking().Future();
                var futureList2 = ctx.EntitySimples.Where(x => x.ColumnInt >= 5).AsNoTracking().Future();
