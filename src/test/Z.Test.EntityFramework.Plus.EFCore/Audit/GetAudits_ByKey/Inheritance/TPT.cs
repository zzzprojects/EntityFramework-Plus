...
namespace Z.Test.EntityFramework.Plus
{
    public partial class Audit_GetAudits_ByKey
    {
        ...
        public void Inheritance_TPT()
        {
            ...
            Inheritance_TPT_Cat auditedItem = null;

            using (var ctx = new TestContext())
            {
                ctx.Inheritance_TPT_Animals.Add(new Inheritance_TPT_Cat() { ColumnInt = 1, ColumnCat = 4 });
                ctx.Inheritance_TPT_Animals.Add(new Inheritance_TPT_Cat() { ColumnInt = 2, ColumnCat = 5 });
                auditedItem = (Inheritance_TPT_Cat)ctx.Inheritance_TPT_Animals.Add(new Inheritance_TPT_Cat() { ColumnInt = 3, ColumnCat = 6 });
            ...
            // UnitTest - Audit
            {
                using (var ctx = new TestContext())
                {
                    var auditEntries = ctx.AuditEntries.Where<Inheritance_TPT_Cat>(auditedItem.ID).ToList();
