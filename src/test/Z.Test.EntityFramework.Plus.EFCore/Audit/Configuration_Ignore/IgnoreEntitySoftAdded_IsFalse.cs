...
namespace Z.Test.EntityFramework.Plus
{
    ...
    {
        [TestMethod]
        public void IgnoreEntitySoftAdded_IsFalse()
        {
            ...
            audit.Configuration.SoftAdded<Entity_Basic>(x => true);
            Assert.AreEqual(false, audit.Configuration.IgnoreEntitySoftAdded);
