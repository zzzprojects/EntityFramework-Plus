...
namespace Z.Test.EntityFramework.Plus
{
    public partial class QueryCache_CacheKey
    {
        ...
        public void Deferred_Constant()
        {
            ...
            {
                var query1 = ctx.Entity_Basics.Where(x => x.ColumnInt > 0).DeferredCount();
                var query2 = ctx.Entity_Basics.Where(x => x.ColumnInt > 1).DeferredCount();
