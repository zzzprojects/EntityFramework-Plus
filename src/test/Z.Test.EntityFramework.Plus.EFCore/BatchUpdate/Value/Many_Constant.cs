    ...
    public partial class BatchUpdate_Value
    {
        ...
        public void Many_Constant()
        {
            ...
            using (var ctx = new TestContext())
            {
                ...
                // ACTION
                var rowsAffected = ctx.Entity_Basic_Manies.Where(x => x.Column1 > 10 && x.Column1 <= 40).Update(x => new Entity_Basic_Many { Column1 = 99, Column2 = 66, Column3 = 33});
