...
{
    public partial class Audit_Configuration_IncludeByInstance
    {
        [TestMethod]
        public void InstanceEntity()
        {
            ...
            audit.Configuration.ExcludeByInstance(x => true);
            ...
            using (var ctx = new TestContext())
            {
                ...
                {
                    audit.Configuration.IncludeByInstance(x => x == entry.Entity);
                }
