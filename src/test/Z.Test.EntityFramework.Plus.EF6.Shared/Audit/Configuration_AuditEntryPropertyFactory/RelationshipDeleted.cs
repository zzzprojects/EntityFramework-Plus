...
namespace Z.Test.EntityFramework.Plus
{
    ...
    {
        [TestMethod]
        public void RelationshipDeleted()
        {
            int leftID;
            int rightID_0;
            int rightID_1;
            ...
            // UnitTest - Audit
            {
                ...
                // Properties
                {
                    ...
                    propertyIndex = 0;
                    Assert.AreEqual("CustomRelationName", entries[0].Properties[propertyIndex].RelationName);
                    Assert.AreEqual("CustomRelationName", entries[1].Properties[propertyIndex].RelationName);
