...
namespace Z.Test.EntityFramework.Plus
{
    ...
    {
        [TestMethod]
        public void EntityModified_IsFalse()
        {
            ...
            audit.Configuration.UseNullForDBNullValue = false;
            ...
            // UnitTest - Audit
            {
                ...
                // Properties
                {
                    ...
                    Assert.AreEqual(DBNull.Value, entries[0].Properties[propertyIndex].OldValue);
                    Assert.AreEqual(DBNull.Value, entries[1].Properties[propertyIndex].OldValue);
                    Assert.AreEqual(DBNull.Value, entries[2].Properties[propertyIndex].OldValue);
                    Assert.AreEqual(DBNull.Value, entries[0].Properties[propertyIndex].NewValue);
                    Assert.AreEqual(DBNull.Value, entries[1].Properties[propertyIndex].NewValue);
                    Assert.AreEqual(DBNull.Value, entries[2].Properties[propertyIndex].NewValue);
                }
            }
