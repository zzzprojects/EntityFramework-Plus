...
{
    public partial class Audit_Configuration_IncludeByEntry
    {
        [TestMethod]
        public void InstanceEntry()
        {
            ...
            audit.Configuration.ExcludeByEntry(x => true);
            ...
            using (var ctx = new TestContext())
            {
                ...
                {
                    audit.Configuration.IncludeByEntry(x => x.Entity == entry.Entity);
                }
