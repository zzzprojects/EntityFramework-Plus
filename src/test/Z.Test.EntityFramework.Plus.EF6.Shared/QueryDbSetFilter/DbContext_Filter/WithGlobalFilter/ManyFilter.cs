...
namespace Z.Test.EntityFramework.Plus
{
    ...
    {
        [TestMethod]
        public void WithGlobalFilter_ManyFilter()
        {
            TestContext.DeleteAll(x => x.Inheritance_Interface_Entities);
            TestContext.Insert(x => x.Inheritance_Interface_Entities, 10);

            using (var ctx = new TestContext(true, true, enableFilter1: true, enableFilter2: true, enableFilter3: true, enableFilter4: true))
            {
