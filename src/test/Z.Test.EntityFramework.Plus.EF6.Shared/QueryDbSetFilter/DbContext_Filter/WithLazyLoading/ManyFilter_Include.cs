...
//    {
//        [TestMethod]
//        public void WithLazyLoading_ManyFilter_Include()
//        {
...
//            using (var ctx = new TestContext(true, true, enableFilter1: false, enableFilter2: false, enableFilter3: false, enableFilter4: false, includeInterface: true, includeBaseClass: true, includeBaseInterface: true))
//            {
//                var rights = ctx.Inheritance_Interface_Entities_LazyLoading.First().Rights;
//                Assert.AreEqual(36, rights.Sum(x => x.ColumnInt));
//            }
//        }
//    }
//}