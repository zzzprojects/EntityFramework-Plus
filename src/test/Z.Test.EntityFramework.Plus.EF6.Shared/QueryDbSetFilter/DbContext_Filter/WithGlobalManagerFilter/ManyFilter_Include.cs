...
namespace Z.Test.EntityFramework.Plus
{
    public partial class QueryFilter_DbContext_DbSetFilter
    {
        ...
        public void WithGlobalManagerFilter_ManyFilter_Include()
        {
            ...
            {
                QueryFilterHelper.CreateGlobalManagerDbSetFilter(true, enableFilter1: false, enableFilter2: false, enableFilter3: false, enableFilter4: false, includeInterface: true, includeBaseClass: true, includeBaseInterface: true);
