...
namespace Z.Test.EntityFramework.Plus
{
    public partial class QueryFilter_DbContext_DbSetFilter
    {
        ...
        public void WithGlobalManagerFilter_ManyFilter_Exclude()
        {
            ...
            {
                QueryFilterHelper.CreateGlobalManagerDbSetFilter(false, enableFilter1: true, enableFilter2: true, enableFilter3: true, enableFilter4: true, excludeInterface: true, excludeBaseClass: true, excludeBaseInterface: true);
