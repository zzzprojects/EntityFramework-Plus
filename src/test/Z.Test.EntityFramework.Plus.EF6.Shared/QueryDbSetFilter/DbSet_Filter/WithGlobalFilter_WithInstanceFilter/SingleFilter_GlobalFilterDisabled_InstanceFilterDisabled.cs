...
namespace Z.Test.EntityFramework.Plus
{
    ...
    {
        [TestMethod]
        public void WithGlobalFilter_WithInstanceFilter_SingleFilter_GlobalFilterDisabled_InstanceFilterDisabled()
        {
            ...
            using (var ctx = new TestContext(true, true, enableFilter1: false))
            {
                ...
                Assert.AreEqual(39, ctx.Inheritance_Interface_Entities.DbSetFilter(
