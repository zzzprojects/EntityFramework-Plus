...
namespace Z.Test.EntityFramework.Plus
{
    public partial class BatchUpdate_Hook
    {
        ...
        public void Interface_Child()
        {
            ...
            {
                Z.EntityFramework.Extensions.BatchUpdateManager.Hook<Inheritance_Interface_Entity>(entity => new Inheritance_Interface_Entity() {ColumnInt = 99});
