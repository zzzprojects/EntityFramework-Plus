...
//    {
//        [TestMethod]
//        public void WithInclude_SingleFilter_Disabled()
//        {
...
//            {
//                var rights = ctx.Inheritance_Interface_Entities_LazyLoading.AsNoDbSetFilter().Include(x => x.Rights).ToList().SelectMany(x => x.Rights);
