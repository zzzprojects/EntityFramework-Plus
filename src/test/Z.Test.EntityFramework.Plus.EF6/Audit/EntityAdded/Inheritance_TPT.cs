...
namespace Z.Test.EntityFramework.Plus
{
    public partial class Audit_EntityAdded
    {
        ...
        public void Inheritance_TPT()
        {
            ...
            {
                TestContext.Insert(ctx, x => x.Inheritance_TPT_Animals, Inheritance_TPT_Cat.Create, 1);
                TestContext.Insert(ctx, x => x.Inheritance_TPT_Animals, Inheritance_TPT_Dog.Create, 2);
            ...
            // UnitTest - Audit
            {
                ...
                // Entries
                {
                    ...
                    // Entries TypeName
                    Assert.AreEqual(typeof (Inheritance_TPT_Cat).Name, entries[0].TypeName);
                    Assert.AreEqual(typeof (Inheritance_TPT_Dog).Name, entries[1].TypeName);
                    Assert.AreEqual(typeof (Inheritance_TPT_Dog).Name, entries[2].TypeName);
                }
