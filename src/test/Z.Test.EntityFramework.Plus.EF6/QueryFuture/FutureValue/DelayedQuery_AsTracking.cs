    ...
    public partial class QueryFuture_FutureValue
    {
        ...
        public void DelayedQuery_AsTracking()
        {
            ...
            using (var ctx = new EntityContext())
            {
                ...
                var futureValue1 = ctx.EntitySimples.Where(x => x.ColumnInt < 5).DelayedCount().FutureValue();
                var futureValue2 = ctx.EntitySimples.Where(x => x.ColumnInt >= 5).DelayedCount().FutureValue();
