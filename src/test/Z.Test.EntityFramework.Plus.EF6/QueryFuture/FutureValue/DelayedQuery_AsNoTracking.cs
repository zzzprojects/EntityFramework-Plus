    ...
    public partial class QueryFuture_FutureValue
    {
        ...
        public void DelayedQuery_AsNoTracking()
        {
            ...
            using (var ctx = new EntityContext())
            {
                ...
                var futureValue1 = ctx.EntitySimples.Where(x => x.ColumnInt < 5).AsNoTracking().DelayedCount().FutureValue();
                var futureValue2 = ctx.EntitySimples.Where(x => x.ColumnInt >= 5).AsNoTracking().DelayedCount().FutureValue();
