...
namespace Z.EntityFramework.Plus
{
    ...
    {
        /// <summary>An IDbSet&lt;TEntity&gt; extension method that gets the DbContext from the query.</summary>
        /// <param name="query">The query act on.</param>
        /// <returns>The DbContext from the query.</returns>
