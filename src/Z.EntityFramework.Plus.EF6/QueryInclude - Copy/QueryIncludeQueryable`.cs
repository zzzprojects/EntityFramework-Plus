...
{
    public class QueryIncludeQueryable<T, T2> : IQueryable<T>
    {
        ...
        public QueryIncludeQueryable(IQueryable<T> originalQuery, Expression<Func<T, IEnumerable<T2>>> selector, IQueryable<T2> includeQuery)
        {
