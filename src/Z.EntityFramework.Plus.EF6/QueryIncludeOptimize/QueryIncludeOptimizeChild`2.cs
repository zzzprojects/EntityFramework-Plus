...
namespace Z.EntityFramework.Plus
{
    ...
    public class QueryIncludeOptimizeChild<T1, T2> : BaseQueryIncludeOptimizeChild
    {
        /// <summary>Constructor.</summary>
        /// <param name="filter">The query filter to apply on included related entities.</param>
        public QueryIncludeOptimizeChild(Expression<Func<T1, IEnumerable<T2>>> filter)
        {
            Filter = filter;
        }
