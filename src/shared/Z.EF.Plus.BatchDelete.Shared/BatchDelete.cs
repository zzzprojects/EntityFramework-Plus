...
//#if EF5
//                if (command.GetType().Name == "NpgsqlCommand" || command.GetType().Name == "PgSqlCommand")
//                {
...
//            var isPostgreSql = (command.GetType().Name == "NpgsqlCommand" || command.GetType().Name == "PgSqlCommand");
...
//            if (isPostgreSql && customQuery.Item1.EndsWith("WHERE TRUE = FALSE", StringComparison.OrdinalIgnoreCase))
//            {
//                return null;
//            }
...
//	            // GET mapping
//	            tableName = string.IsNullOrEmpty(entity.GetSchema()) ?
//		            string.Concat("[", entity.GetTableName(), "]") :
//		            string.Concat("[", entity.GetSchema(), "].[", entity.GetTableName(), "]");
//#endif
...
//#else
//	                propertyAndColumnName.Add(new Tuple<string, string>(propertyKey.Name, propertyKey.GetColumnName())); 
//#endif
//				}
