...
//        internal Expression<Func<T, T>> AddHook<T>(Expression<Func<T, T>> updateExpression)
//        {
//            foreach (var hook in BatchUpdateManager.InternalHooks)
//            {
//                if (hook.Item1.IsAssignableFrom(typeof(T)))
//                {
//                    var expressionHook = hook.Item2;
...
//                    // get new bindings
//                    //accessors
//                    var memberInitExpressionHook = ((dynamic)expressionHook).Body as MemberInitExpression;
//                    var bindingsHooks = memberInitExpressionHook.Bindings;

//                    bool foundOne = false;
//                    foreach (var bindingsHook in bindingsHooks)
//                    {
//                        if (bindings.All(x => x.Member != bindingsHook.Member))
//                        {
//                            foundOne = true;
//                            bindings.Add(bindingsHook);
//                        }
//                    }

//                    if (foundOne)
//                    {
//                        var memberInitHooked = Expression.MemberInit(memberInitExpression.NewExpression, bindings);
//                        updateExpression = Expression.Lambda<Func<T, T>>(memberInitHooked, updateExpression.Parameters);
//                    }
//                }
//            }
...
//        {
//            updateFactory = AddHook(updateFactory);
...
//			var isDevPostgreSQL = command.GetType().Name == "PgSqlCommand";
//			var isPostgreSQL = isDevPostgreSQL || command.GetType().Name == "NpgsqlCommand"  ;
...
//			if (customQuery.Item1.EndsWith("WHERE 1 = 0", StringComparison.OrdinalIgnoreCase))
//			{
//				return null;
//			}
...
//				var parameterPrefix = (isOracle || isDevPostgreSQL) ? ":" : isHana ? "" : "@";
...
//#else
//				tableName = string.IsNullOrEmpty(entity.GetSchema()) ? string.Concat("[", entity.GetTableName(), "]") : string.Concat("[", entity.GetSchema(), "].[", entity.GetTableName(), "]");
//#endif
...
//#else
//	                columnKeys.Add(propertyKey.GetColumnName());
//#endif
//				}
...
//#else
//				   tableName = string.Concat("`", entity.GetTableName(), "`");
//#endif
...
//#else
//	                tableName = string.IsNullOrEmpty(entity.GetSchema()) ? entity.GetTableName() : string.Concat(entity.GetSchema(), ".", entity.GetTableName());
//#endif
//				}
//                else
//                {
...
//						commandText.IndexOf(Environment.NewLine + "    FROM", StringComparison.OrdinalIgnoreCase) != -1 ?
...
//                        && valueSql[0] == '['
//                        && valueSql.IndexOf("]", StringComparison.OrdinalIgnoreCase) != -1
//                        && valueSql.IndexOf("]", StringComparison.OrdinalIgnoreCase) == valueSql.IndexOf("].[", StringComparison.OrdinalIgnoreCase)
//                        )
//                    {
