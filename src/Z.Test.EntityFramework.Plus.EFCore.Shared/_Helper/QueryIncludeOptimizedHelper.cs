        ...
        public static void InsertOneToOneAndMany(string resharperFix = null, bool? single1 = null, bool? single2 = null, bool? single3 = null, bool? single4 = null, bool? many1 = null, bool? many2 = null, bool? many3 = null, bool? many4 = null)
        {
            ...
            // Level 1
            {
                if (single1.HasValue)
                {
                    ...
                    left.Entity.Single_Right = new Association_OneToSingleAndMany_Right();
                    rights1.Add(left.Entity.Single_Right);
                }
                else if (many1.HasValue)
                {
                    if (!many1.Value) return;

                    left.Entity.Many_Right = new List<Association_OneToSingleAndMany_Right>();
                    left.Entity.Many_Right.Add(new Association_OneToSingleAndMany_Right());
                    rights1.Add(left.Entity.Many_Right[0]);
                }
