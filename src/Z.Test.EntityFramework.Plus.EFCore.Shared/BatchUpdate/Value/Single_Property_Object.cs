...
namespace Z.Test.EntityFramework.Plus
{
    ...
    {
        [TestMethod]
        public void Single_Property_Object()
        {
            ...
            using (var ctx = new TestContext())
            {
                ...
                // ACTION
                var tuple = new Tuple<int>(99);
                var rowsAffected = ctx.Entity_Basics.Where(x => x.ColumnInt > 10 && x.ColumnInt <= 40).Update(x => new Entity_Basic {ColumnInt = tuple.Item1});
