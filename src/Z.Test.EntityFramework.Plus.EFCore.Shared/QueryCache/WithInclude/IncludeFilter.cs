...
namespace Z.Test.EntityFramework.Plus
{
    public partial class QueryCache_WithInclude
    {
        ...
        public void IncludeFilter()
        {
            ...
            {
                // BEFORE
                var itemCountBefore = ctx.Association_OneToMany_Lefts.IncludeFilter(x => x.Rights).FromCache().Count();
                ...
                // AFTER
                var itemCountAfter = ctx.Association_OneToMany_Lefts.IncludeFilter(x => x.Rights).FromCache().Count();
